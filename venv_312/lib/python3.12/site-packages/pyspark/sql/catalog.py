...
class Catalog:
    ...
    def functionExists(self, functionName: str, dbName: Optional[str] = None) -> bool:
        ...
        if dbName is None:
            ...
            raise PySparkNotImplementedError(
                ...
                messageParameters={
                    "feature": "dbName",
                    "suggestion": "functionExists(`dbName.tableName`)",
                },
            )
            # END-EDGE
        else:
    ...
    def getFunction(self, functionName: str) -> Function:
        ...
        ...  # doctest: +SKIP
        >>> spark.catalog.getFunction("my_func1")  # doctest: +SKIP
        Function(name='my_func1', catalog='spark_catalog', namespace=['default'], ...

        Using the fully qualified name for function name.

        >>> spark.catalog.getFunction("default.my_func1")  # doctest: +SKIP
        Function(name='my_func1', catalog='spark_catalog', namespace=['default'], ...
        >>> spark.catalog.getFunction("spark_catalog.default.my_func1")  # doctest: +SKIP
        Function(name='my_func1', catalog='spark_catalog', namespace=['default'], ...
    ...
    def listColumns(self, tableName: str, dbName: Optional[str] = None) -> List[Column]:
        ...
        if dbName is None:
            ...
            raise PySparkNotImplementedError(
                ...
                messageParameters={
                    "feature": "dbName",
                    "suggestion": "listColumns(`dbName.tableName`)",
                },
            )
            # END-EDGE
        else:
    ...
    def tableExists(self, tableName: str, dbName: Optional[str] = None) -> bool:
        ...
        if dbName is None:
            ...
            raise PySparkNotImplementedError(
                ...
                messageParameters={
                    "feature": "dbName",
                    "suggestion": "tableExists(`dbName.tableName`)",
                },
            )
            # END-EDGE
        else:
        ...
        **options: str,
        ...
        if (
            ...
            raise PySparkNotImplementedError(
                errorClass="DEPRECATED_FEATURE_BLOCKED",
                messageParameters={
                    "feature": "Catalog.createExternalTable",
                    "suggestion": "createTable",
                },
            )
        # END-EDGE
    ...
    def dropGlobalTempView(self, viewName: str) -> bool:
        ...
        Examples
        --------
        >>> spark.createDataFrame([(1, 1)]).createGlobalTempView("my_table")  # doctest: +SKIP

        Dropping the global view.

        >>> spark.catalog.dropGlobalTempView("my_table")  # doctest: +SKIP
        True
    ...
    def registerFunction(
        ...
        if (
            ...
            raise PySparkNotImplementedError(
                errorClass="DEPRECATED_FEATURE_BLOCKED",
                messageParameters={
                    "feature": "Catalog.registerFunction",
                    "suggestion": "spark.udf.register",
                },
            )
        # END-EDGE
