...
from pyspark.sql.utils import NumpyHelper, is_remote, require_minimum_plotly_version
...
def collect_top_k(col: Column, num: int, reverse: bool) -> Column:
    if is_remote():
        ...
        return _invoke_function_over_columns("collect_top_k", col, lit(num), lit(reverse))
